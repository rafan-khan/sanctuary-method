...
- **Sunday** — High-volume input inside the Sanctuary
- **Mon / Tue** — Active recall inside the Sanctuary
- **Wednesday** — Pre-sleep diffuse mode session for overnight consolidation
...
Tested over 11 days using Japanese hiragana and katakana:

- 76 characters encoded across 6–7 sessions under 30 minutes each
...
TSM v2 — applying the protocol to JEE-level physics. Results forthcoming.